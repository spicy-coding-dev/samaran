...
- எந்தத் தீங்கு செய்யும் ரசாயனங்களும் இல்லை
...
🔸 **கிடைக்கும் அளவுகள்**
- ஸ்டிக்
- பக்கெட் பேக் (அளவுகள் client decide பண்ணி சொல்வார்கள்)
...
- Pure Milk + Natural Ingredients combo
  ...
  },
  {
    ...
    fullDetails: `
🔸 முக்கிய தன்மைகள்
100% தூய்மையான பசும்பாலில் இருந்து தயாரிப்பு

Soft & Fresh Texture

Cooking-friendly — grill, fry, curry எல்லாவற்றுக்கும் பொருத்தமானது
Preservative இல்லாமல் நம்பகமான சுவை
Daily protein intake-ku perfect
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-12">
          {products.map((item) => (
            ...
            >
              ...
              <h3 className="text-2xl font-semibold text-gray-800 mb-2" style={{fontFamily:"inter"}}>
                {item.title}
              </h3>

              <p className="text-gray-600 text-sm leading-relaxed mb-4" style={{fontFamily:"Poppins "}}>
                {item.description}
              </p>
      ...
      >
        ...
        <DialogContent dividers>
          ...
          <p
            className="text-gray-800 text-[16px] leading-relaxed whitespace-pre-line"
